...
export const NavbarSection: React.FC = () => {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 border-b transition-all duration-300 transform-gpu ${
        isScrolled
          ? 'bg-[#FAFAFA]/95 backdrop-blur-md shadow-md py-2 border-gray-200/50'
